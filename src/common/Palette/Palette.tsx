...
<<<<<<< HEAD
    selectedPaletteElementId = uuid(),
=======
    sendValue,
>>>>>>> origin/editColorWindow
}: PaletteProps) => {
...
<<<<<<< HEAD
        ...
        selectedPaletteElementId = selectedElId;
        const isSelected = selectedPaletteElementId === paletteElementId;
=======
        const paletteElementId = String(i);
        const isSelected = selectedElId === paletteElementId;
>>>>>>> origin/editColorWindow
